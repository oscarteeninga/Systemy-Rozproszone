...
public interface DevicePrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    {
        return getHelp(com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default String getHelp(java.util.Map<String, String> context)
    {
        return _iceI_getHelpAsync(context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<java.lang.String> getHelpAsync()
    {
        return _iceI_getHelpAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.String> getHelpAsync(java.util.Map<String, String> context)
    {
        return _iceI_getHelpAsync(context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.String> _iceI_getHelpAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.String> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "getHelp", null, sync, null);
