		...
		try {
			...
			do
			{
				try
				{
					...
					{
						double res = synCalc1.min(new HashSet<Double>(Arrays.asList(4.1, 4.5, 4.9)));
						System.out.println("op(MIN, (4.1, 4.5, 4.9) returned " + res);
					}
					else if(line.equals("min-empty"))
					{
						double res = synCalc1.min(new HashSet<Double>(Arrays.asList()));
						System.out.println("op(MIN, () returned " + res);
					}
